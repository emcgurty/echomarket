class HomeController < ApplicationController
  ...
  # def item_search
    ...
    # is_community = " AND user_id = ?, #{session[:user_id]} "
    # if request.post?
...
# 
          # split_query_string.each do |sqs|
            ...
            # else
                  # @search_items = Lenders.find(:all, :select=> 'lender_item_id',:readonly => true, :conditions => ["UPPER(item_model) like ?
                # OR UPPER(item_description) like ? AND user_id = ?", get_search_value, get_search_value, session[:user_id]])
            # end  
# 
...
#             
             ...
             # else
                # @item_search_query = Lenders.find(:all, :readonly => true, :conditions => build_conditions_string + is_active_is_save + is_community )
             # end
#             
#                
#             
...
#           
             ...
             # else
                # @item_search_query = Lenders.find(:all, :readonly => true, :conditions => replace_square_brackets +  is_active_is_save + is_community).uniq
             # end
#             
#           
          # session[:item_search_query] = "lender"
...
#             
          ...
          # else
            # @item_search_query = Borrowers.find(:all, :readonly => true, :conditions => build_conditions_string  + is_active_is_save + is_community) 
          # end
#             
#             
...
#           
          ...
          # else
            # @item_search_query = Borrowers.find(:all, :readonly => true, :conditions => replace_square_brackets + is_active_is_save + is_community).uniq 
          # end
#           
#           
#           
