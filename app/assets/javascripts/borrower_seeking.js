$(document).ready(function() {
    ...
    $("#borrowers_home_phone").bind('change', function() {
        ...
        if ($("#borrowers_home_phone").val() !=  '')  {
            if (($("#borrowers_home_phone").val() == $("#borrowers_cell_phone").val())  ||
                ($("#borrowers_home_phone").val() == $("#borrowers_alternative_phone").val()))   {
    ...
    $("#borrowers_cell_phone").bind('change', function() {
        ...
        if ($("#borrowers_cell_phone").val() !=  '')  {
            if (($("#borrowers_cell_phone").val() == $("#borrowers_home_phone").val())  ||
                ($("#borrowers_cell_phone").val() == $("#borrowers_alternative_phone").val()))   {
    ...
    $("#borrowers_alternative_phone").bind('change', function() {
        ...
        if ($("#borrowers_alternative_phone").val() !=  '')  {
            if (($("#borrowers_alternative_phone").val() == $("#borrowers_home_phone").val())  ||
                ($("#borrowers_alternative_phone").val() == $("#borrowers_cell_phone").val()))   {
...
function validateUseWhichBorrowerContactAddress() {
    ...
    if ((use_which_ca == 1) || (use_which_ca == 2  || useAddressAlternative )) {
        ...
        if (($("#" + whichType + "_address_line_1_alternative").val() == '')  ||
            ($("#" + whichType + "_city_alternative").val() == '') ||
            ($("#" + whichType + "_postal_code_alternative").val() == '') ||
            (($("#" + whichType + "_state_id_alternative option:selected").text() == 'Please select') || ($("#" + whichType + "_state_id_alternative option:selected").text() == ''))
            ||
            (($("#" + whichType + "_country_id_alternative option:selected").text() == 'Please select') || ($("#" + whichType + "_country_id_alternative option:selected").text() == ''))
            )
...

{
    ...
    if  ((($("#borrowers_state_id option:selected").text() == "Please select") ||
        ($("#borrowers_state_id option:selected").val() == '')) && ($("#borrowers_country_id option:selected").text() == "United States")){
    ...
    if  ((($("#borrowers_state_id option:selected").text() == "Please select") ||
        ($("#borrowers_state_id option:selected").val() == null))
    && ($("#borrowers_country_id option:selected").val() != "US")){
